...
# Промпт в режиме проекта: эталоны уже прикреплены как источники — описывать их не надо,
# но полные инструкции по генерации нужны, иначе ChatGPT отвечает текстом, а не картинкой.
PROJECT_PROMPT = os.getenv("PROJECT_PROMPT", """\
Вот фото исходного товара. Сгенерируй ПРЕМИАЛЬНУЮ КАРТОЧКУ ТОВАРА на его основе, \
оформив в едином стиле с эталонами из проекта.

ВАЖНО:
1. Товар с фото сохрани АБСОЛЮТНО ИДЕНТИЧНО: те же цветы, декор, ленты, бабочки, мишура — \
все элементы как на исходнике. Не заменяй и не добавляй ничего.
2. Убери ВСЁ лишнее с фона (мебель, стены, плинтус, домашнюю обстановку).
3. Размести товар по центру кадра.
4. Чистый студийный светло-графитовый фон с мягким премиальным градиентом — как на эталонах.
5. Сверху: заголовок "РИТУАЛЬНАЯ КОМПОЗИЦИЯ" зелёным цветом, декоративный разделитель, \
подзаголовок "ПРЕМИАЛЬНОЕ ИСПОЛНЕНИЕ".
6. Снизу: три бейджа с иконками — "АККУРАТНЫЙ ДЕКОР", "ВЫРАЗИТЕЛЬНАЯ КОМПОЗИЦИЯ", \
"ЭЛЕГАНТНАЯ ПОДАЧА".
7. Формат 1:1 (квадрат), стиль современный, дорогой, минималистичный, каталожный. \
Без шумов, посторонних теней, визуального мусора.
